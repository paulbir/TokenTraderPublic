...
namespace CoinFlexConnector.JSONExtensions
{
    ...
    public class SettableJsonConverter : JsonConverter
    {
        ...
        public class TypedConverter<T> : ITypedConverter where T : struct
        {
            ...
            {
                if (value == null) return (Settable<T>)null;
                ...
                catch (Exception) { return (Settable<T>)null; }
            }
        ...
        static readonly Dictionary<Type, ITypedConverter> Converters = new Dictionary<Type, ITypedConverter>();
        ...
        ITypedConverter GetConverter(Type objectType)
        {
        ...
        public static Type ResolveSettableTypeParameter(Type settableType)
        {
            ...
            while (toCheck != null && toCheck != typeof(object))
            {
                ...
                if (typeof(Settable<>) == cur) { return toCheck.GetGenericArguments().Single(); }
