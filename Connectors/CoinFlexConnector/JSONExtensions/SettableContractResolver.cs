...
namespace CoinFlexConnector.JSONExtensions
{
    /// <summary>
    ...
    {
        public static readonly SettableContractResolver Instance = new SettableContractResolver();

        static readonly MethodInfo ShouldSerializeSettableBuilderMethodInfo =
            typeof(SettableContractResolver).GetMethod("ShouldSerializeSettableBuilder", BindingFlags.Static | BindingFlags.Public);
        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            if (settableTypeParameter != null) { property.ShouldSerialize = MakePredicateForSettableType(settableTypeParameter, property); }
