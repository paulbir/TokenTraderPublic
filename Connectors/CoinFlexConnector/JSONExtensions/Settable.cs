...
namespace CoinFlexConnector.JSONExtensions
{
    ...
    public struct Settable<T> where T : struct
    {
        ...
        /// </summary>
        public static Settable<T> Undefined => default;
        ...
        /// </summary>
        public bool HasValue => IsSet && _hasValue;
        ...
        public T Value
        {
            get
            {
                if (IsSet && _hasValue) return _value;
        ...
        public Settable(T? value)
        {
            ...
            _value    = _hasValue ? value.Value : default;
        }
        ...
        {
            var s = new Settable<T> {IsSet = true, _hasValue = value.HasValue};
        ...
        public static implicit operator Settable<T>(T value)
        {
            return new Settable<T> {IsSet = true, _hasValue = true, _value = value};
        }
        ...
        public static implicit operator T(Settable<T> value)
        {
            if (value.HasValue) return value._value;
        ...
        {
            return IsSet ? _hasValue ? _value.ToString() : "null" : "undefined";
        }
    }
}