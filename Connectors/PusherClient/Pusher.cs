...
namespace PusherClient
{
    ...
    public class Pusher : EventEmitter, IPusher, ITriggerChannels
    {
        ...
        void IPusher.EmitPusherEvent(string channelName, string eventName, string data)
        {
            EmitEvent(channelName, eventName, data);
        }
        ...
        void IPusher.EmitChannelEvent(string channelName, string eventName, string data)
        {
            ...
            {
                Channels[channelName].EmitEvent(channelName, eventName, data);
            }
        }
        ...
        private string ConstructUrl()
        {
            ...
            return $"{scheme}{_options.Host}/app/{_applicationKey}?protocol={_options.ProtocolVersion}&client={_options.ClientName}&version={_options.VersionNumber}";
        }
